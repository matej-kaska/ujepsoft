		...
		<div className={`guide lists ${open ? "open" : ""}`}>
			...
			{open && (
				<ol>
					...
					<td>&nbsp;</td>
					<li>
						Poté se zobrazí detailní informace Issue a na spodní straně stránky naleznete pole s komentářem.
					</li>
					<div className="image">
						<img
							src="/src/images/guides/addcomment.webp"
							alt="addcomment"
						/>
						<ul>
						...
						<ul>
							<strong>2</strong> &rarr; Místo pro nahrání případných příloh –⁠⁠⁠⁠⁠⁠

			...
			{open && (
				<ol>
					...
					<div className="image">
						...
						<ul>
							<strong>3</strong> &rarr; &quot;URL odkaz&quot; slouží pro přesun na oficiální stránku repozitáře na GitHubu.
						</ul>
						<ul>
							<strong>4</strong> &rarr; &quot;X&quot; slouží pro odebrání příslušného repozitáře z databáze.
						</ul>
					</div>
					<td>&nbsp;</td>
					Pokud je vložen nesprávný odkaz nebo nejste kolaborantem v repozitáři, objeví se chybová hláška <i>&quot;Nejste collaborantem tohoto repozitáře!&quot;</i>.
					<div className="image">
